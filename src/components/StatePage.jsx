...
const StatePage = () => {
  ...
  const stateInfo = {
    ...
    'Kerala': {
        images: ['/images/Kerala_land.webp', '/images/Kerala.jpg'], // Array of image paths
    ...
    'Uttar Pradesh': {
      images: ['/images/Uttar_pradesh.jpg'],
    ...
    'Madhya Pradesh': {
      images: ['/images/Madhya_pradesh.jpg'],
    ...
    'Andhra Pradesh': {
      images: ['/images/Andhra_pradesh.jpg'],
    ...
    'Chhattisgarh': {
      images: ['/images/Chhattisgarh.jpg'],
